...
def main() -> int:
    parser = argparse.ArgumentParser(description="Extract stage-13 frozen audio real embeddings.")
    ...
    parser.add_argument("--out", default="outputs/embeddings/audio_real_embeddings.npz")
    parser.add_argument("--failures-out", default="outputs/reports/audio_real_failures.json")
    parser.add_argument("--summary-out", default="outputs/reports/audio_real_quality_summary.json")
    ...
    write_audio_quality_summary(summary, args.summary_out)
