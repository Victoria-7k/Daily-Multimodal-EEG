#!/usr/bin/env python3
"""Build Video temporal-token NPZ for EQL-CAF pipeline smoke tests."""
...
def main() -> int:
    ...
    parser.add_argument("--source", type=Path, required=True, help="Existing Video/Face window-level token NPZ.")
    parser.add_argument("--emb-key", help="Defaults to video_emb, then face_emb.")
