...
def main() -> int:
    ...
    if not protocols or set(protocols) - {"cross_day", "within_subject_day"}:
        raise ValueError("the main matrix supports cross_day and repaired within_subject_day only")
