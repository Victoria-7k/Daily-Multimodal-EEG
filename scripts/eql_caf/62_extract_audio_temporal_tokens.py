#!/usr/bin/env python3
"""Build Audio temporal-token NPZ for EQL-CAF pipeline smoke tests."""
...
def main() -> int:
    ...
    parser.add_argument("--source", type=Path, required=True, help="Existing Audio window-level token NPZ.")
    parser.add_argument("--emb-key", default="audio_emb")
