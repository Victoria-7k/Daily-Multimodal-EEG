#!/usr/bin/env python3
"""Build EEG temporal-token NPZ for EQL-CAF pipeline smoke tests."""
...
def main() -> int:
    ...
    parser.add_argument("--source", type=Path, required=True, help="Existing EEG window-level token NPZ.")
    parser.add_argument("--emb-key", default="eeg_emb")
