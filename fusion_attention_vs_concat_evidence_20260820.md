...
> 生成脚本：`scripts/56_build_fusion_attention_vs_concat_evidence.py`；源数据与完整 JSON 副本见文末「产物与复现」。
...
| 生成脚本 | `scripts/56_build_fusion_attention_vs_concat_evidence.py` |
