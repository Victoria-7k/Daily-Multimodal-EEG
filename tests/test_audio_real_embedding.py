...
def _write_audio_cache(cache_root: Path, *, sample_id: str) -> Path:
    cache_dir = cache_root / "audio_clips" / sample_id / "wavlm_frozen_v1"
        ...
        json.dumps(
            {
                ...
                "modality": "audio",
                "encoder_profile": "wavlm_frozen_v1",
                "cache_key": f"{sample_id}/audio/wavlm_frozen_v1",
